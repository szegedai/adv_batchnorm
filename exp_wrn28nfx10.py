...
def main():
    ...
    def objective(params):
        ...
        model = wide_resnet28nfx10(10, **CIFAR10_STATS)
        model.to(device)
        ...
        config = {
            ...
            'dataset': 'CIFAR10',
            'training_type': 'adv',
            'architecture': 'WideResNet28nfx10'
        }
        ...
        metrics = train_classifier(model, loss_fn, optimizer, train_loader, test_loader, attack,
                                   ...
                                   callbacks=[
                                       CheckpointCallback(
                                           f'../checkpoints/adv_wresnet28nfx10_cutmix_{list(params.values())}',
                                           metric_comparator=metrics_comparator
                                       ),
                                       WandBLoggerCallback('AdvBatchNorm', f'adv-wresnet28nfx10-cutmix-{list(params.values())}', config),
                                       CutMixCallback(1.),
